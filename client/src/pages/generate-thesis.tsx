...
import { GraduationCap, Sparkles, Upload, Download, Save, X, FileIcon } from "lucide-react";
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Thesis Configuration</CardTitle>
            ...
            <CardContent className="space-y-6">
              <Tabs defaultValue="text" className="w-full">
                ...
                <TabsContent value="text" className="space-y-4">
                  <div>
                    <Label htmlFor="topic">Thesis Topic/Research Question</Label>
                    <Textarea
                      id="topic"
                      placeholder="Enter your thesis topic, research question, or abstract..."
                      value={topic}
                      onChange={(e) => setTopic(e.target.value)}
                      className="min-h-32 mt-2"
                      data-testid="input-thesis-topic"
                    />
              ...
              <div className="space-y-4 pt-4 border-t">
                <div>
                  ...
                  <Select value={targetPages} onValueChange={setTargetPages}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="50-100">50-100 Pages</SelectItem>
                      <SelectItem value="100-150">100-150 Pages</SelectItem>
                      <SelectItem value="150-200">150-200 Pages</SelectItem>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    data-testid="switch-include-toc"
                  />
                </div>
              </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card className="h-full">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>Thesis Preview</CardTitle>
              ...
              {isGenerating && (
                <div className="space-y-4 mb-6">
                  ...
                  <div className="text-sm text-muted-foreground text-center">
                    Generating thesis chapters with AI...
                  </div>
                </div>
              )}
              ...
              <div className="border rounded-lg bg-muted/10 min-h-[600px] p-8 overflow-auto">
                {generatedContent ? (
                  ...
                  <div className="text-center text-muted-foreground py-16">
                    ...
                    <p>Your thesis document will appear here</p>
                    <p className="text-sm mt-2">Configure settings and click "Generate Thesis" to start</p>
                  </div>
                )}
              </div>
            </CardContent>
